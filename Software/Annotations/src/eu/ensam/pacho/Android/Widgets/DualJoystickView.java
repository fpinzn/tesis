...
public class DualJoystickView extends android.widget.LinearLayout {
	...
	private Joystick3DView stickL;
	private Joystick3DView stickR;

	private View pad;

	public DualJoystickView(Context context) {
		super(context);
		stickL = new Joystick3DView(context,false);
		stickR = new Joystick3DView(context,true);
    	Resources r = getResources();	
		stickL.setVrpnId(r.getInteger(R.id.VrpnRotationJoystick));
		stickR.setVrpnId(r.getInteger(R.id.VrpnDirectionJoystick));
	...
	public DualJoystickView(Context context, AttributeSet attrs) {
		...
		stickL = new Joystick3DView(context, attrs,false);
		stickR = new Joystick3DView(context, attrs,true);
    	Resources r = getResources();	
		stickL.setVrpnId(r.getInteger(R.id.VrpnRotationJoystick));
		stickR.setVrpnId(r.getInteger(R.id.VrpnDirectionJoystick));
		initDualJoystickView();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		stickL.TAG = "L";
		stickR.TAG = "R";
		stickL.setPointerId(Joystick3DView.INVALID_POINTER_ID);
		stickR.setPointerId(Joystick3DView.INVALID_POINTER_ID);
	...
	public void setOnJostick3DMovedListener(Joystick3DMovedListener left, Joystick3DMovedListener right) {
		stickL.setOnJostick3DMovedListener(left);
		stickR.setOnJostick3DMovedListener(right);
	}
